...
int main() {
  ...
  fetcher->Load(BuildItcm({
    {AsInt(InstrType::kAddi), 31, 0, 0, 128},
    {AsInt(InstrType::kAddi), 1, 0, 0, 20},
    {AsInt(InstrType::kCall), 1, 0, 0, 0},
    {AsInt(InstrType::kAddi), 4, 0, 0, 256},
    {AsInt(InstrType::kHalt), 0, 0, 0, 4},
    {AsInt(InstrType::kAddi), 2, 0, 0, 120},
    {AsInt(InstrType::kLd), 3, 2, 0, 0},
    {AsInt(InstrType::kAddi), 3, 3, 0, 4},
    {AsInt(InstrType::kSt), 2, 3, 0, 0},
    {AsInt(InstrType::kReturn), 0, 0, 0, 0}
  }));
